...
if [ "$sim_mode" == "ac" ]; then
{
csv_file="$script_path/configuration_side/table_supply_list_ac.csv"
}
elif [ "$sim_mode" == "dc" ]; then
{
csv_file="$script_path/configuration_side/table_supply_list_dc.csv"
}
else
{
csv_file="$script_path/configuration_side/table_supply_list.csv"
}
fi
